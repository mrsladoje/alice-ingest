...
| Template catalog memory ceiling | 512 MB | `roles/template_catalog/defaults/main.yml` |
| Template catalog ceiling | 20,000 templates | `roles/template_catalog/defaults/main.yml` |
