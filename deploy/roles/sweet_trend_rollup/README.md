# Ansible Role: sweet_trend_rollup
...
**Retention runs in the script.** `sweet_opensearch` creates the index and its
...
incomplete. `trend_entity_cap_warn` in `sweet_anomaly_detection` sits below
