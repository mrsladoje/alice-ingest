...
| `mkconfig.py` | Renders `deploy/roles/loggy_collector/templates/collector.yaml.j2` — the real production template — then patches the knobs under test. The rig therefore cannot drift from production. |
