#!/usr/bin/env python3
"""Render the real `loggy_opensearch` script for the rig.
...
ROLE = os.path.join(REPO, "deploy", "roles", "loggy_opensearch", "templates")
GROUP_VARS = os.path.join(REPO, "deploy", "group_vars", "all.yml")
ROLE_DEFAULTS = os.path.join(REPO, "deploy", "roles", "loggy_opensearch",
                             "defaults", "main.yml")
